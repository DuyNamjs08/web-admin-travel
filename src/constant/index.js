...
import { HiHome , HiUserCircle ,HiFlag , HiChatBubbleOvalLeft , HiCube  } from "react-icons/hi2";
...
export const menuSidebar = [
    { id: 1, title: "Thống kê", path: '/', icon:<HiHome /> },
    { id: 2, title: "Hệ thống", path: '/user', icon:<HiUserCircle /> },
    { id: 3, title: "Dịa điểm", path: '/address', icon:<HiUserCircle /> },
    { id: 3333, title: "Khách sạn", path: '/hotels', icon:<HiUserCircle /> },
    { id: 4, title: "Tour", path: '/tour', icon:<HiFlag /> },
    { id: 5, title: "Bình luận", path: '/comments', icon:<HiChatBubbleOvalLeft /> },
    { id: 6, title: "Lịch sử tour", path: '/incognito-comments', icon:<HiCube /> },
    { id: 7, title: "Tin tức", path: '/posts', icon:<HiCube /> },
    { id: 8, title: "Liên hệ", path: '/contact', icon:<HiCube /> },
]

export const dataHomepage = [
    { id: 1, title: 'Tổng  user',  },
    { id: 2, title: 'Tổng  tour',  },
    { id: 3, title: 'Tổng comments',  },
]
